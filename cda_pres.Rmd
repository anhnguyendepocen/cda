...
Specify row/column number, or row/column name, in backets to extract parts of a table.   
\ 
...
We can also use subsetting brackets to extract parts of tables, but again need to specifiy third dimension.
